...
export const onRequestPost: PagesFunction<Env> = async ({ request, env }) => {
  try {
    ...
    console.log('[register] Registrando usuário:', username, email);
    ...
    console.log('[register] Colunas disponíveis:', columnNames);
    ...
    console.log('[register] Bindings:', bindings);
    ...
    console.log('[register] ✅ Usuário criado com ID:', result.meta.last_row_id);

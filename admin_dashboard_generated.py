...
<h2 style="margin-top:0;">Usuáries</h2>
                    ...
                    <!-- IF blocked_words START -->
                        ...
                        <div class="pagination" style="margin-top:1rem; display:flex; gap:.4rem; justify-content:center; align-items:center; flex-wrap:wrap; font-size:.7rem;">
                            ...
                            {% for page_num in range(1, blocked_words_pagination.pages + 1) %}
                                <!-- IF page_num == blocked_words_pagination.page START -->
                                ...
                                <!-- IF END -->
                            <!-- FOR END -->
                            <!-- IF blocked_words_pagination.has_next START -->
            ...
            <table class="admin-users" role="grid" aria-describedby="legenda-usuarios">
                ...
                <tbody>
                <!-- FOR u IN usuaries START -->
                    <tr>
                        <td data-label="ID">{u.id}</td>
                        <td data-label="Username">{u.username} <!-- IF u.is_superadmin START --><span class="badge badge-superadmin">SUPERADMIN</span><!-- ELIF u.is_admin --><span class="badge badge-admin">ADMIN</span><!-- IF END --></td>
                        <td data-label="Email">{u.email}</td>
                        <td data-label="Privilégios">
                            <!-- IF u.is_superadmin START -->Superadmin<!-- ELIF u.is_admin -->Admin<!-- ELSE --><span class="muted">Padrão</span><!-- IF END -->
                            <!-- IF u.is_banned START --><br><span class="badge" style="background:#222;color:#fff;">BANIDO</span><!-- ELIF u.suspended_until and u.suspended_until > now --><br><span class="badge" style="background:#f5a540;color:#fff;">SUSPENSO</span><!-- IF END -->
                        </td>
                        <td data-label="Ações">
                            <!-- IF not u.is_superadmin START -->
                                <div class="actions-stack">
                                    ...
                                    <!-- IF END -->
                                    <!-- IF u.suspended_until and u.suspended_until > now START -->
                            ...
                            <!-- ELSE --><span class="muted">Protegide</span><!-- IF END -->
                        </td>
                    </tr>
                <!-- FOR END -->
                </tbody>
            </table>
            <!-- IF users_pagination START -->
            <div class="pagination" style="margin-top:1rem; display:flex; gap:.4rem; justify-content:center; align-items:center; flex-wrap:wrap; font-size:.7rem;">
                ...
                {% for page_num in range(1, users_pagination.pages + 1) %}
                    <!-- IF page_num == users_pagination.page START -->
                        <span class="pag-btn disabled" style="background:var(--accent); color:#fff;">{page_num}</span>
                    <!-- ELSE -->
                        <a href="/admin/dashboard/{page_num, _anchor='geral'}" class="pag-btn">{page_num}</a>
                    <!-- IF END -->
                <!-- FOR END -->
                <!-- IF users_pagination.has_next START -->
            ...
            <label class="lbl">Exibir em</label>
                ...
                <input type="checkbox" name="show_on_edu" value="1" checked /> Card Gramátike Edu
                        ...
                        <div style="margin-top:.4rem;">
                            ...
                            <!-- IF session.get('last_divulgacao_image') START -->
                ...
                <div class="card">
                        ...
                        <div class="promo-item" style="background:var(--bg-alt); border:1px solid var(--border); border-radius:14px; padding:.7rem .75rem .85rem; position:relative; display:flex; flex-direction:column; gap:.55rem;">
                            <div style="display:flex; justify-content:space-between; align-items:center; gap:.6rem;">
                                ...
                                <form method="POST" action="/main/admin_divulgacao_update/{d.id}" style="margin:0; display:flex; gap:.35rem; align-items:center;">
                                    ...
                                    <button type="submit" class="action-btn<!-- IF d.ativo START --> promo-active<!-- IF END -->" style="font-size:.52rem; padding:3px 8px;">{{ 'Ativo' if d.ativo else 'Inativo' }}</button>
                                </form>
                            </div>
                            <!-- IF d.texto START --><p style="margin:0; font-size:.58rem; line-height:1.3; color:var(--text-soft);">{d.texto}</p><!-- IF END -->
                            <!-- IF d.imagem START -->
                    ...
                    <label class="lbl">Exibir em</label>
                                    <div style="display:flex; gap:.6rem; flex-wrap:wrap;">
                                        <label style="display:flex; align-items:center; gap:.35rem; font-size:.65rem;">
                        <input type="checkbox" name="show_on_index" value="1" <!-- IF d.show_on_index START -->checked<!-- IF END --> /> Card Gramátike (Início)
                                            <input type="hidden" name="show_on_index" value="0" />
                                        </label>
                                        <label style="display:flex; align-items:center; gap:.35rem; font-size:.65rem;">
                        <input type="checkbox" name="show_on_edu" value="1" <!-- IF d.show_on_edu START -->checked<!-- IF END --> /> Card Gramátike Edu
                                            <input type="hidden" name="show_on_edu" value="0" />
                                        </label>
                    ...
                    <!-- IF edu_topics START -->
                        ...
                        <!-- IF artigo_topics START -->
                            <div style="display:grid; gap:.8rem; grid-template-columns:1fr;">
                                <!-- FOR topic IN artigo_topics START -->
                ...
                <div class="edu-box" style="margin-top:1rem;">
                    ...
                    <!-- IF edu_topics START -->
                        ...
                        <!-- IF apostila_topics START -->
                            <div style="display:grid; gap:.8rem; grid-template-columns:1fr;">
                                <!-- FOR topic IN apostila_topics START -->
                                <div style="background:#f9fbfd; border:1px solid #e3e9f0; border-radius:12px; padding:.9rem;">
                                    <div style="display:flex; justify-content:space-between; align-items:start; gap:.8rem;">
                                        <div style="flex:1;">
                                            <div style="font-weight:700; font-size:.85rem; color:#333; margin-bottom:.3rem;">{topic.nome}</div>
                ...
                <div class="edu-box" style="margin-top:1rem;">
                    ...
                    <!-- IF edu_topics START -->
                        ...
                        <!-- IF podcast_topics START -->
                            <div style="display:grid; gap:.8rem; grid-template-columns:1fr;">
                                <!-- FOR topic IN podcast_topics START -->
                                <div style="background:#f9fbfd; border:1px solid #e3e9f0; border-radius:12px; padding:.9rem;">
                                    <div style="display:flex; justify-content:space-between; align-items:start; gap:.8rem;">
                                        <div style="flex:1;">
                                            <div style="font-weight:700; font-size:.85rem; color:#333; margin-bottom:.3rem;">{topic.nome}</div>
                ...
                <div class="edu-box" style="margin-top:1rem;">
                    ...
                    <!-- IF edu_topics START -->
                        ...
                        <!-- IF redacao_topics START -->
                            <div style="display:grid; gap:.8rem; grid-template-columns:1fr;">
                                <!-- FOR topic IN redacao_topics START -->
                                <div style="background:#f9fbfd; border:1px solid #e3e9f0; border-radius:12px; padding:.9rem;">
                                    <div style="display:flex; justify-content:space-between; align-items:start; gap:.8rem;">
                                        <div style="flex:1;">
                                            <div style="font-weight:700; font-size:.85rem; color:#333; margin-bottom:.3rem;">{topic.nome}</div>
                        ...
                        <form id="form-exercicio" method="POST" action="/admin/edu_create_question" style="display:flex; flex-direction:column; gap:.6rem;">
                            ...
                            <div style="display:flex; gap:.5rem; flex-wrap:wrap; align-items:flex-start;">
                                <select name="topic_id" id="ex-topic" required style="flex:1; min-width:180px;">
                                    ...
                                    <!-- FOR t IN topics START --><option value="{t.id}">{t.nome}</option><!-- FOR END -->
                                </select>
            ...
            <div class="cards-grid">
                ...
                <div class="card" style="grid-column:1/-1;">
                    ...
                    <table class="admin-users" style="font-size:.7rem;">
                        ...
                        <!-- FOR r IN reports START -->
                            <tr>
                                ...
                                <td><!-- IF r.resolved START --><span class="badge" style="background:#4caf50;color:#fff;">Resolvida</span><!-- ELSE --><span class="badge" style="background:#ff9800;color:#fff;">Aberta</span><!-- IF END --></td>
                                <td>
                                    <!-- IF not r.resolved START -->
                                        ...
                                        <!-- IF END -->
                                    <!-- ELSE --><span class="muted">—</span><!-- IF END -->
                                </td>
                            </tr>
                        <!-- ELSE -->
                    ...
                    <div style="margin-top:1rem; display:flex; gap:0.5rem; justify-content:center; align-items:center;">
                        ...
                        <!-- IF reports_pagination.has_next START -->
